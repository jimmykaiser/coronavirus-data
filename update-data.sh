...
# Get data from today
git cat-file -p $today_hash:latest/last7days-by-modzcta.csv > "last7days-by-modzcta-today.csv"
echo "Got data as of $TODAY"
# Get data from seven days prior
git cat-file -p $week_ago_hash:latest/last7days-by-modzcta.csv > "last7days-by-modzcta-last-week.csv"
